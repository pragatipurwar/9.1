...
# Import Data Set
data_set <- read.csv("C:/Users/Pragati/Assignment/Example_WearableComputing_weight_lifting_exercises_biceps_curl_variations.csv")
View(data_set)
...
library(caTools)
set.seed(92)
split = sample.split(data$classe, SplitRatio = 0.70) 
